...
class DateFormatterService {
  ...
  String formatLong(DateTime date) => DateFormat.yMMMMd(locale).format(date);

  /// "14/06/2025" / "06/14/2025"
  String formatShort(DateTime date) => DateFormat.yMd(locale).format(date);

  /// "14 juin" / "June 14"
  String formatDayMonth(DateTime date) => DateFormat.MMMMd(locale).format(date);
  ...
  static DateFormatterService of(String locale) => DateFormatterService(locale);
}
