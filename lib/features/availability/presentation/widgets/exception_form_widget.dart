  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          const Text('Jour exceptionnel', style: AppTypography.h2),
              ...
              children: [
                Expanded(
                  child: OutlinedButton(
                    ...
                    child: Text('Ouvre ${_opensAt.format(context)}'),
                  ),
                ),
                ...
                Expanded(
                  child: OutlinedButton(
                    ...
                    child: Text('Ferme ${_closesAt.format(context)}'),
                  ),
                ),
              ],
            ),
